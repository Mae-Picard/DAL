...
while not window_should_close():
    ...
    if campain.in_world:
        ...
        for i in range(round(-s.player.life) // 2, round(s.player.life) // 2 + (round(s.player.life) % 2) + 1):
            draw_texture(s.UI_life_texture, mb_x + i * 32, mb_y - 170, (150 - i * 7, 100 + i * 7, 120 + i * 5, 255))
